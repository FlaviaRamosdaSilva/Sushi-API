...
class Database {
  ...
  init () {
    this.connection = new Sequelize('postgres://new_code_sushi_user:WKWyaZLGmKVOa4jjbMiygjeUetsPBbIJ@dpg-cn9ku2md3nmc73dirigg-a/new_code_sushi') // to instanciando meu sequelize // clicando o ctrl+init ali em verde ele vai pra pasta de user.js
